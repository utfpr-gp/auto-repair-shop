...
public class AutoRepairShopController {
	...
	public ModelAndView index(){
		...
		List<AutoRepairShopDTO> autoDTOs = auto.stream().map(s -> autoRepairShopMapper.toResponseDto(s)).collect(Collectors.toList());
	...
	public ModelAndView save(@Validated AutoRepairShopDTO dto, Errors errors, RedirectAttributes redirectAttributes)
		...
		redirectAttributes.addFlashAttribute("msg", "Oficina salva com sucesso!");
